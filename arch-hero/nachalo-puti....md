...
Если у вас Legacy Boot система и вы видете, что где-то что-то не работает, сообщите об этом мне. Исторически так сложилось, что на Legacy Boot у меня нету ни одного устройства.&#x20;
